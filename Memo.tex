...
\subsubsection{Initialiseur}\index{initialiseur}\index{\code{\_\_init\_\_}}
...
Pour détruire un objet, on définit la méthode \code{\_\_del\_\_}\index{\code{\_\_del\_\_}}. On l'appelle comme ceci:
\begin{minted}[fontsize = \footnotesize, frame = single]{python}
del objet
\end{minted}
