...
\subsection{Aide au développeur et débogage (\emph{debugging})}
...
class _Helper(builtins.object)
 ...
 |      list of weak references to the object (if defined)
    ...
    \item[\mintinline{python3}{breakpoint()}]
...
\end{minted}
\item[\mintinline{python3}{object.__repr__(self)}] Renvoie \mintinline{python3}|f"<{type(self)} object at {id(self)}>"|.
...
\begin{enumerate}
    ...
    \item \mintinline{python3}{artiste/1/} il cherche la ligne correspondante dans le fichier \mintinline{python3}{urls.py}. Il trouve alors la ligne \mintinline{text}{artiste/<artiste_id>}, il appelle donc la vue \mintinline{text}{artiste(request=<HttpRequest object>, question_id=1)}.
\end{enumerate}
